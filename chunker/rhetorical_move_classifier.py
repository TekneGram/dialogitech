...
class RhetoricalMoveEnricher:
    ...
    def enrich_heading_splits(self, classified_splits: list[ClassifiedHeadingSplit]) -> list[ClassifiedHeadingSplit]:
        for split in classified_splits:
            for chunk in split.chunks:
                ...
                self.validate_result(result, section_label=section_label)
    ...
    @classmethod
    def validate_result(cls, result: RhetoricalMoveResult, *, section_label: SectionLabel) -> None:
