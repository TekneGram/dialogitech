        ...
        for chunk, embedding in zip(chunks, embeddings, strict=True):
            ...
            embedded_chunks.append(
                EmbeddedChunkRecord(
                    ...
                    paper_type_source=chunk.paper_type_source,
                    paper_type_confidence=chunk.paper_type_confidence,
                    paper_type_used_context=chunk.paper_type_used_context,
                    paper_type_reason=chunk.paper_type_reason,
                    rhetorical_moves=[dict(move) for move in chunk.rhetorical_moves],
                    rhetorical_move_source=chunk.rhetorical_move_source,
                    rhetorical_move_used_context=chunk.rhetorical_move_used_context,
                    rhetorical_move_reason=chunk.rhetorical_move_reason,
